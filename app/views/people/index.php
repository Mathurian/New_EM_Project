...
<div class="two-col">
	<div>
		<h3>Contestants</h3>
		<table>
			<tr><th>Number</th><th>Name</th><th>Preferred Name</th><th>Email</th><th>Gender</th><th>Pronouns</th><th>Can Login</th><th>Actions</th></tr>
			<?php foreach ($contestants as $p): ?>
				<tr>
					...
					<td><?= htmlspecialchars($p['pronouns'] ?? '-') ?></td>
	...
	<div>
		<h3>Judges</h3>
		<table>
			<tr><th>Name</th><th>Preferred Name</th><th>Email</th><th>Gender</th><th>Pronouns</th><th>Can Login</th><th>Actions</th></tr>
			<?php foreach ($judges as $j): ?>
				<tr>
					...
					<td><?= htmlspecialchars($j['pronouns'] ?? '-') ?></td>
