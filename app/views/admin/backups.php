...
<div class="card">
	...
	<div class="backup-info">
		...
		<p><a href="<?= url('admin/backups/test-log-level') ?>" class="btn btn-sm btn-secondary">🧪 Test Log Level</a></p>
		<p><a href="<?= url('admin/backups/test-logging') ?>" class="btn btn-sm btn-secondary">📝 Test Logging</a></p>
	</div>
