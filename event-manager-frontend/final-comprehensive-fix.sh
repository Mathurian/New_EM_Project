#!/bin/bash
# Final Comprehensive Fix - Updates ALL Files
# This script fixes ALL remaining files with the correct imports
...
echo "🔧 Final Comprehensive Fix - Update ALL Files"
echo "============================================="
...
# Step 1: Update ALL page files with correct imports
print_status "Step 1: Updating ALL page files..."
...
import { useQuery } from '@tanstack/react-query'
import { api, formatDate } from '../utils'
import { Card, CardContent, CardDescription, CardHeader, CardTitle, Badge, Button, LoadingSpinner } from '../components'
...
print_success "All page files updated"

# Step 2: Update all role dashboard files
...
# Update TallyMasterDashboard.tsx
...
# Step 3: Fix LoginPage.tsx
print_status "Step 3: Fixing LoginPage.tsx..."
...
print_success "LoginPage.tsx fixed"

# Step 4: Fix layout components
print_status "Step 4: Fixing layout components..."
