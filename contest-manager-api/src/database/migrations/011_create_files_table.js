...
export async function up(knex) {
  await knex.schema.createTable('files', (table) => {
    ...
    table.string('entity_type').notNullable() // 'contest', 'contestant', 'judge', 'document'
    table.uuid('entity_id').notNullable()
    table.string('category').defaultTo('general') // 'profile_image', 'document', 'contest_image', etc.
